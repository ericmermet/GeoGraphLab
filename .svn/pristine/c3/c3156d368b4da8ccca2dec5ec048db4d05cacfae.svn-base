...
public class PanelMainDraw extends JPanel {
	...
	public Polygon polygonSelect = new Polygon();
	...
	public ArrayList<NoeudGraphique> listeOrigines = new ArrayList<NoeudGraphique>();
	public ArrayList<NoeudGraphique> listeDestinations = new ArrayList<NoeudGraphique>();
	...
	public void paint(Graphics gC) {
		...
		if (this.carte.variablesDeCarte.afficheEnveloppeConvexe) {
			EnveloppeConvexe ev = new EnveloppeConvexe(	this.carte.getNom() + Messages.getString("PanelMainDraw.txtSupConvexHull"),
														this.carte.getGraphe(),
														10); //$NON-NLS-1$
			
			this.gC2D.setColor(this.carte.variablesDeCarte.convexHullColor);
			
			this.gC2D.fill(ev.getEnveloppePolygone()); //$NON-NLS-1$
...
//					this.parent.getPanelMainDrawActif().carte.getLegendeDeLaCarte();
//					Double valeurIndiceZone = iterZone.setValeursGraphiquesMoyenne();
//					iterZone.setIndicateurCouleur(this.carte.getNomIndicateurCourant(), 
					couleurDeLaZone = this.carte.getLegendeDeLaCarte().getColorValeur(valeurIndiceZone.doubleValue(), this.carte.getLegendeDeLaCarte().limites);
		...
		this.gC2D.setStroke(new BasicStroke(3.0f));
		this.gC2D.setColor(Color.YELLOW);
		this.gC2D.draw(this.polygonSelect);
