...
public class ToolBar extends JToolBar {
	...
	JButton bSelectPolygon = new JButton();
	JButton bMoveNode = new JButton();
	JButton bSelectMore = new JButton();
	JButton bSelectSpanninTree = new JButton();
	...
	private void initialize() {
		...
		//TODO change images
		Icon imgSelectPolygon = new ImageIcon(getClass().getResource(ConstantesImages.imgSelectPolygon));
		Icon imgSelectPolygonSelected = new ImageIcon(getClass().getResource(ConstantesImages.imgSelectPolygonSelected));
		...
		Icon imgSelectSpanningTree = new ImageIcon(getClass().getResource(ConstantesImages.imgSelectSpanningTree));
...
//		Icon imgAddMapLayer = new ImageIcon(""); //$NON-NLS-1$
		...
		this.bSelectPolygon = new JButton(imgSelectPolygon);
		this.bSelectPolygon.setSelectedIcon(imgSelectPolygonSelected);
		this.listButtonMenuBar.add(this.bSelectPolygon);
		...
		this.bSelectSpanninTree = new JButton(imgSelectSpanningTree);
		this.bSelectSpanninTree.setSelectedIcon(imgSelectSelected);
		...
		this.bSelectPolygon.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				toggleButtonInMenuBar(ToolBar.this.bSelectPolygon);
				ToolBar.this.parent.getPanelMainDrawActif().setOutilsSelectionne(ConstantesApplication.selectionModePolygon);
				ToolBar.this.parent.setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
			}
		});
		...
		this.bSelectSpanninTree.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				OutilsSelections.selectSpanningTree(ToolBar.this.parent.getPanelMainDrawActif().carte);
			}
		});
		...
		this.bMergeNodes.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				ToolBar.this.parent.panelActif.carte.getVueDuGraphe().reunirNoeudsSurSelection();
...
//				detectImpasse.detectionComposantesConnexes();
		...
		add(this.bSelect);
		add(this.bSelectPolygon);
		add(this.bMoveNode);
		add(this.bSelectMore);
		add(this.bSelectSpanninTree);
//		add(this.bZoomIn);
//		add(this.bZoomOut);
		add(this.bDrag);
		add(this.bResize);
	...
	public void activateTheButtonForPanel(PanelMainDraw p) {
		...
		switch (p.getOutilsSelectionne()) {
			...
			case ConstantesApplication.selectionModePolygon:
				bSelectedForPanel = this.bSelectPolygon;
				break;
