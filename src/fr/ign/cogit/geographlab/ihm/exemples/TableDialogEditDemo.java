...
package fr.ign.cogit.geographlab.ihm.exemples;

/*
 * TableDialogEditDemo.java requires these files: ColorRenderer.java
 * ColorEditor.java
 */
...
public class TableDialogEditDemo extends JPanel {
	...
	class MyTableModel extends AbstractTableModel {
		...
		private Object[][] data = { { "Mary", new Color(153, 0, 153), "Snowboarding", new Integer(5), new Boolean(false) }, { "Alison", new Color(51, 51, 153), "Rowing", new Integer(3), new Boolean(true) },
				{ "Kathy", new Color(51, 102, 51), "Knitting", new Integer(2), new Boolean(false) }, { "Sharon", Color.red, "Speed reading", new Integer(20), new Boolean(true) }, { "Philip", Color.pink, "Pool", new Integer(10), new Boolean(false) } };
