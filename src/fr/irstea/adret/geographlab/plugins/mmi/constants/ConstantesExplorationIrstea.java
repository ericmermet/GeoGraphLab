 ...
 * 2007 - 2013
 *
 * ConstantesExplorationIrstea.java in fr.irstea.adret.geographlab.plugins.ihm.constantes
 * 
 */
package fr.irstea.adret.geographlab.plugins.mmi.constants;

/**
 * @author eric
 *
 */
public class ConstantesExplorationIrstea {
