...
import fr.irstea.adret.geographlab.plugins.mmi.exploration.HierarchicalAnalysis;
...
public class DecisionSupportOpenShape extends Thread {
	 ...
	 * 
	 */
	public DecisionSupportOpenShape(MainWindow mainWindow, String file, ArrayList<Indicator> listIndicators, ArrayList<Operation> listOperations) {
	...
	public void run() {
		...
		try {
			...
			//Cross retained fields between shape & xml loaded file
...
//			}
			HierarchicalAnalysis hA = new HierarchicalAnalysis(this.mainWindow.panelActif, this.listIndicators, this.listOperations);
			hA.createIndicators(textField);
...
//						}
			...
			hA.createOperations(this.listOperations);
